  ...
  return (
    <div className="contenete">
      <div>
        <div>
          <Link to={"/home"}>
            <button className="returnhome"></button>
          </Link>
        </div>
      ...
      <div className="preview-section">
        <div className="preview">
          ...
          <p>Altura: {inputs.height}</p>
          <p>Peso: {inputs.weight}</p>
          <p>Años de vida: {inputs.life_span}</p>
          <p>Temperamentos: {inputs.temperament}</p>
          <p>
            imagen
            {inputs.image && (
              <img src={inputs.image} alt="Vista previa de la imagen" />
            )}
          </p>
        </div>
      </div>
